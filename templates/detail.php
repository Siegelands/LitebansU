                ...
                <div class="relative mx-auto w-full max-w-xl" data-animate>
                    ...
                    <div class="relative overflow-hidden rounded-[2rem] border border-white/70 bg-white/75 p-8 shadow-2xl shadow-gray-950/10 backdrop-blur-2xl">
                        <div class="flex flex-col items-center gap-6 sm:flex-row">
                            <img src="<?= htmlspecialchars($punishment['avatar'], ENT_QUOTES, 'UTF-8') ?>" alt="<?= htmlspecialchars($punishment['name'], ENT_QUOTES, 'UTF-8') ?>" class="h-32 w-32 rounded-3xl object-cover shadow-xl shadow-gray-950/15 ring-1 ring-gray-200">
